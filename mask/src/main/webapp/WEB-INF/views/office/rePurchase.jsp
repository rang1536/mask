                                       ...
                                       <div class="card">
                                           ...
                                           <div class="card-block">
                                           	<c:forEach var="list" items="${list }" varStatus="status">
											   		<div class="col-sm-10">
														<input type="radio" name="goods" id="goods${status.index }" value="${list.rePrice }" onclick="chgGoods('${list.rePrice }','${status.index }')">
														<label for="goods${status.index }">${list.goodsName} (<fmt:formatNumber value="${list.rePrice }" pattern="#,###" />)</label>
...
<script>
	...
	window.onload = function(){
		...
		console.log($("#goodsCode").val(),$("#goodsName").val(),$("#point").val());
	}
