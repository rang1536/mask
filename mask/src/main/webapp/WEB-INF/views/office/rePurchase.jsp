	                        	...
	                        	<div class="form-group row">
									<div class="col-xl-4">
                                       ...
                                       <div class="card">
                                           ...
                                           <div class="card-block">
												<p><input type="radio" name="goods" id="goods1" checked="checked"> <label for="goods1">항균 마스크 20EA (24,000p)</label></p>
												<p><input type="radio" name="goods" id="goods2"> <label for="goods2">목화 마스크 30EA (24,000p)</label></p>
                                           </div>
                                       </div>
									...
									<div class="col-xl-4">
                                       ...
                                       <div class="card">
                                           ...
                                           <div class="card-block">
												...
												<p>결재포인트 : <code>24,000</code></p>
												<p>-----------------------------------------</p>
												<p>잔여포인트 : <code><fmt:formatNumber value="${point-24000 }" pattern="#,###" /></code></p>
                                           </div>
                                       </div>
                                       <!-- Line Tooltip card end -->
                                    </div>
